@include('bladeComps/home_head-amp')
<body>
...
<nav>
    <ul>
        ...
        <li><a href="#2"><img  src="assets/images/icon-2.png" alt="bout ME"/> <em>About ME</em></a></li>
...
<div class="slides">
    <div class="slide" id="1">
        <div id="slider-wrapper">
            <div id="amp-image-slider">
                <ul>
                    <li class="active-amp-img">
            ...
            <div id="thumbnail">
                <ul>
                    <li class="active"><amp-img src="storage/images/2-denoise1.jpg" alt="" /></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        for ($i=0;$i<count($post);$i++){
                            ...
                            $to_wright=$to_wright.'<div class="col-md-12">
                                            <div class="featured-item">
                                                <a href="'.$full_post.'">
                                                    <amp-img layout="responsive" src="'.$url_to_show.'" alt="'.$post[$i]->alt.'"/>
                                                </a>
...
<!-- Additional Scripts -->
<script src="assets/js-amp/owl.js"></script>
<script src="assets/js-amp/accordations.js"></script>
<script src="assets/js-amp/main.js"></script>
